...
func SetupDBSubnetGroup(mgr ctrl.Manager, o controller.Options) error {
	name := managed.ControllerName(nsapitypes.DBSubnetGroupGroupKind)
	...
	r := managed.NewReconciler(mgr,
		resource.ManagedKind(nsapitypes.DBSubnetGroupGroupVersionKind),
		reconcilerOpts...)
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*nsapitypes.DBSubnetGroup)
	if !ok {
...
func (e *external) Observe(ctx context.Context, mgd resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mgd.(*nsapitypes.DBSubnetGroup)
	if !ok {
