...
func (e *external) Create(ctx context.Context, mg cpresource.Managed) (managed.ExternalCreation, error) {
	...
	if resp.ResourcePolicy.PolicyName != nil {
		cr.Spec.ForProvider.Name = resp.ResourcePolicy.PolicyName
	} else {
...
type external struct {
	...
	preUpdate      func(context.Context, *svcapitypes.ResourcePolicy, *svcsdk.PutResourcePolicyInput) error
	postUpdate     func(context.Context, *svcapitypes.ResourcePolicy, *svcsdk.PutResourcePolicyOutput, managed.ExternalUpdate, error) (managed.ExternalUpdate, error)
}
...
func nopPreUpdate(context.Context, *svcapitypes.ResourcePolicy, *svcsdk.PutResourcePolicyInput) error {
	return nil
}
func nopPostUpdate(_ context.Context, _ *svcapitypes.ResourcePolicy, _ *svcsdk.PutResourcePolicyOutput, upd managed.ExternalUpdate, err error) (managed.ExternalUpdate, error) {
	return upd, err
}
