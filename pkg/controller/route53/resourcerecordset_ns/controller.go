...
func SetupResourceRecordSet(mgr ctrl.Manager, o controller.Options) error {
	name := managed.ControllerName(nsapitypes.ResourceRecordSetGroupKind)
	...
	r := managed.NewReconciler(mgr,
		resource.ManagedKind(nsapitypes.ResourceRecordSetGroupVersionKind),
		reconcilerOpts...)
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&nsapitypes.ResourceRecordSet{}).
		Complete(r)
}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*nsapitypes.ResourceRecordSet)
	if !ok {
