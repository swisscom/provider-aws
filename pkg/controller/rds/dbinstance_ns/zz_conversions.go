...
// operation.
func GenerateDescribeDBInstancesInput(cr *nsapitypes.DBInstance) *svcsdk.DescribeDBInstancesInput {
...
// GenerateDBInstance returns the current state in the form of *nsapitypes.DBInstance.
func GenerateDBInstance(resp *svcsdk.DescribeDBInstancesOutput) *nsapitypes.DBInstance {
	cr := &nsapitypes.DBInstance{}
...
func GenerateCreateDBInstanceInput(cr *nsapitypes.DBInstance) *svcsdk.CreateDBInstanceInput {
...
func GenerateModifyDBInstanceInput(cr *nsapitypes.DBInstance) *svcsdk.ModifyDBInstanceInput {
...
func GenerateDeleteDBInstanceInput(cr *nsapitypes.DBInstance) *svcsdk.DeleteDBInstanceInput {
