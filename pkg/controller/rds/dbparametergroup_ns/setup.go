...
func SetupDBParameterGroup(mgr ctrl.Manager, o controller.Options) error {
	name := managed.ControllerName(nsapitypes.DBParameterGroupGroupKind)
	opts := []option{
		func(e *external) {
	...
	r := managed.NewReconciler(mgr,
		resource.ManagedKind(nsapitypes.DBParameterGroupGroupVersionKind),
		reconcilerOpts...)
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&nsapitypes.DBParameterGroup{}).
		Complete(r)
}
...
func preObserve(_ context.Context, cr *nsapitypes.DBParameterGroup, obj *svcsdk.DescribeDBParameterGroupsInput) error {
	obj.DBParameterGroupName = pointer.ToOrNilIfZeroValue(meta.GetExternalName(cr))
	return nil
}

func postObserve(_ context.Context, cr *nsapitypes.DBParameterGroup, obj *svcsdk.DescribeDBParameterGroupsOutput, obs managed.ExternalObservation, err error) (managed.ExternalObservation, error) {
	if err != nil {
...
func (c *custom) preCreate(ctx context.Context, cr *nsapitypes.DBParameterGroup, obj *svcsdk.CreateDBParameterGroupInput) error {
...
func (c *custom) preUpdate(ctx context.Context, cr *nsapitypes.DBParameterGroup, obj *svcsdk.ModifyDBParameterGroupInput) error {
	obj.DBParameterGroupName = pointer.ToOrNilIfZeroValue(meta.GetExternalName(cr))
...
func (c *custom) postUpdate(ctx context.Context, cr *nsapitypes.DBParameterGroup, _ *svcsdk.DBParameterGroupNameMessage, upd managed.ExternalUpdate, _ error) (managed.ExternalUpdate, error) {
...
func preDelete(_ context.Context, cr *nsapitypes.DBParameterGroup, obj *svcsdk.DeleteDBParameterGroupInput) (bool, error) {
	obj.DBParameterGroupName = pointer.ToOrNilIfZeroValue(meta.GetExternalName(cr))
	return false, nil
}
...
func (c *custom) isUpToDate(ctx context.Context, cr *nsapitypes.DBParameterGroup, obj *svcsdk.DescribeDBParameterGroupsOutput) (bool, string, error) {
...
func (c *custom) getCurrentDBParameters(ctx context.Context, cr *nsapitypes.DBParameterGroup) ([]*svcsdk.Parameter, error) {
...
func (c *custom) ensureParameterGroupFamily(ctx context.Context, cr *nsapitypes.DBParameterGroup) error {
...
func (c *custom) parametersToUpdate(cr *nsapitypes.DBParameterGroup, current []*svcsdk.Parameter) []svcapitypes.CustomParameter {
...
func (c *custom) parametersToReset(cr *nsapitypes.DBParameterGroup, current []*svcsdk.Parameter) []*svcsdk.Parameter {
