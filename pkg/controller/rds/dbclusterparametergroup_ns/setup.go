package dbclusterparametergroup_ns
...
func SetupDBClusterParameterGroup(mgr ctrl.Manager, o controller.Options) error {
	name := managed.ControllerName(nsapitypes.DBClusterParameterGroupGroupKind)
	opts := []option{
		func(e *external) {
	...
	r := managed.NewReconciler(mgr,
		resource.ManagedKind(nsapitypes.DBClusterParameterGroupGroupVersionKind),
		reconcilerOpts...)
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&nsapitypes.DBClusterParameterGroup{}).
		Complete(r)
}
...
func preObserve(_ context.Context, cr *nsapitypes.DBClusterParameterGroup, obj *svcsdk.DescribeDBClusterParameterGroupsInput) error {
	obj.DBClusterParameterGroupName = pointer.ToOrNilIfZeroValue(meta.GetExternalName(cr))
	return nil
}

func postObserve(_ context.Context, cr *nsapitypes.DBClusterParameterGroup, _ *svcsdk.DescribeDBClusterParameterGroupsOutput, obs managed.ExternalObservation, err error) (managed.ExternalObservation, error) {
	if err != nil {
...
func (c *custom) preCreate(ctx context.Context, cr *nsapitypes.DBClusterParameterGroup, obj *svcsdk.CreateDBClusterParameterGroupInput) error {
...
func (c *custom) preUpdate(ctx context.Context, cr *nsapitypes.DBClusterParameterGroup, obj *svcsdk.ModifyDBClusterParameterGroupInput) error {
	obj.DBClusterParameterGroupName = pointer.ToOrNilIfZeroValue(meta.GetExternalName(cr))
...
func (c *custom) postUpdate(ctx context.Context, cr *nsapitypes.DBClusterParameterGroup, _ *svcsdk.DBClusterParameterGroupNameMessage, upd managed.ExternalUpdate, _ error) (managed.ExternalUpdate, error) {
...
func preDelete(_ context.Context, cr *nsapitypes.DBClusterParameterGroup, obj *svcsdk.DeleteDBClusterParameterGroupInput) (bool, error) {
	obj.DBClusterParameterGroupName = pointer.ToOrNilIfZeroValue(meta.GetExternalName(cr))
	return false, nil
}
...
func (c *custom) isUpToDate(ctx context.Context, cr *nsapitypes.DBClusterParameterGroup, out *svcsdk.DescribeDBClusterParameterGroupsOutput) (bool, string, error) {
...
func (c *custom) getCurrentDBClusterParameters(ctx context.Context, cr *nsapitypes.DBClusterParameterGroup) ([]*svcsdk.Parameter, error) {
...
func (c *custom) ensureParameterGroupFamily(ctx context.Context, cr *nsapitypes.DBClusterParameterGroup) error {
...
func (c *custom) parametersToUpdate(cr *nsapitypes.DBClusterParameterGroup, current []*svcsdk.Parameter) []svcapitypes.CustomParameter {
...
func (c *custom) parametersToReset(cr *nsapitypes.DBClusterParameterGroup, current []*svcsdk.Parameter) []*svcsdk.Parameter {
