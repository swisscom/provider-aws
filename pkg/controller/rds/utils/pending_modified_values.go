...
// PendingModifiedValues so that they are considered during isUpToDate checks. Exception is Engine version, which is handled separately.
func SetPmvDBCluster(obs *svcsdk.DescribeDBClustersOutput) { //nolint:gocyclo
...
func applyInstancePendingCloudwatchLogsExports(cr *svcsdk.DescribeDBInstancesOutput) {
...
func applyClusterPendingCloudwatchLogsExports(cr *svcsdk.DescribeDBClustersOutput) {
