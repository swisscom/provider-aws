...
// operation.
func GenerateDescribeGlobalClustersInput(cr *nsapitypes.GlobalCluster) *svcsdk.DescribeGlobalClustersInput {
	res := &svcsdk.DescribeGlobalClustersInput{}

	return res
}

// GenerateGlobalCluster returns the current state in the form of *nsapitypes.GlobalCluster.
func GenerateGlobalCluster(resp *svcsdk.DescribeGlobalClustersOutput) *nsapitypes.GlobalCluster {
	cr := &nsapitypes.GlobalCluster{}
...
func GenerateCreateGlobalClusterInput(cr *nsapitypes.GlobalCluster) *svcsdk.CreateGlobalClusterInput {
...
func GenerateModifyGlobalClusterInput(cr *nsapitypes.GlobalCluster) *svcsdk.ModifyGlobalClusterInput {
...
func GenerateDeleteGlobalClusterInput(cr *nsapitypes.GlobalCluster) *svcsdk.DeleteGlobalClusterInput {
