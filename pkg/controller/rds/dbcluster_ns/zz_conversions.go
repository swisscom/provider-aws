...
// operation.
func GenerateDescribeDBClustersInput(cr *nsapitypes.DBCluster) *svcsdk.DescribeDBClustersInput {
	res := &svcsdk.DescribeDBClustersInput{}

	return res
}

// GenerateDBCluster returns the current state in the form of *nsapitypes.DBCluster.
func GenerateDBCluster(resp *svcsdk.DescribeDBClustersOutput) *nsapitypes.DBCluster {
	cr := &nsapitypes.DBCluster{}
...
func GenerateCreateDBClusterInput(cr *nsapitypes.DBCluster) *svcsdk.CreateDBClusterInput {
...
func GenerateModifyDBClusterInput(cr *nsapitypes.DBCluster) *svcsdk.ModifyDBClusterInput {
...
func GenerateDeleteDBClusterInput(cr *nsapitypes.DBCluster) *svcsdk.DeleteDBClusterInput {
