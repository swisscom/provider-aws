...
func SetupDBCluster(mgr ctrl.Manager, o controller.Options) error {
	name := managed.ControllerName(nsapitypes.DBClusterGroupKind)
	...
	r := managed.NewReconciler(mgr,
		resource.ManagedKind(nsapitypes.DBClusterGroupVersionKind),
		reconcilerOpts...)
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&nsapitypes.DBCluster{}).
		Complete(r)
}

func preObserve(_ context.Context, cr *nsapitypes.DBCluster, obj *svcsdk.DescribeDBClustersInput) error {
...
func (e *custom) postObserve(ctx context.Context, cr *nsapitypes.DBCluster, resp *svcsdk.DescribeDBClustersOutput, obs managed.ExternalObservation, err error) (managed.ExternalObservation, error) {
	if err != nil {
...
func (e *custom) preCreate(ctx context.Context, cr *nsapitypes.DBCluster, obj *svcsdk.CreateDBClusterInput) (err error) { //nolint:gocyclo
...
func generateRestoreDBClusterFromS3Input(cr *nsapitypes.DBCluster) *svcsdk.RestoreDBClusterFromS3Input { //nolint:gocyclo
...
func generateRestoreDBClusterFromSnapshotInput(cr *nsapitypes.DBCluster) *svcsdk.RestoreDBClusterFromSnapshotInput { //nolint:gocyclo
...
func generateRestoreDBClusterToPointInTimeInput(cr *nsapitypes.DBCluster) *svcsdk.RestoreDBClusterToPointInTimeInput { //nolint:gocyclo
...
func (e *custom) isUpToDate(ctx context.Context, cr *nsapitypes.DBCluster, out *svcsdk.DescribeDBClustersOutput) (bool, string, error) { //nolint:gocyclo
...
func isStorageTypeUpToDate(cr *nsapitypes.DBCluster, out *svcsdk.DescribeDBClustersOutput) bool {
...
func isPreferredMaintenanceWindowUpToDate(cr *nsapitypes.DBCluster, out *svcsdk.DescribeDBClustersOutput) bool {
...
func isPreferredBackupWindowUpToDate(cr *nsapitypes.DBCluster, out *svcsdk.DescribeDBClustersOutput) bool {
...
func isBackupRetentionPeriodUpToDate(cr *nsapitypes.DBCluster, out *svcsdk.DescribeDBClustersOutput) bool {
...
func isEngineVersionUpToDate(cr *nsapitypes.DBCluster, out *svcsdk.DescribeDBClustersOutput) bool {
...
func isDBClusterParameterGroupNameUpToDate(cr *nsapitypes.DBCluster, out *svcsdk.DescribeDBClustersOutput) bool {
...
func isPortUpToDate(cr *nsapitypes.DBCluster, out *svcsdk.DescribeDBClustersOutput) bool {
...
func areVPCSecurityGroupIDsUpToDate(cr *nsapitypes.DBCluster, out *svcsdk.DescribeDBClustersOutput) bool {
...
func (e *custom) preUpdate(ctx context.Context, cr *nsapitypes.DBCluster, obj *svcsdk.ModifyDBClusterInput) error {
	obj.DBClusterIdentifier = pointer.ToOrNilIfZeroValue(meta.GetExternalName(cr))
...
//nolint:gocyclo
func (e *custom) postUpdate(ctx context.Context, cr *nsapitypes.DBCluster, obj *svcsdk.ModifyDBClusterOutput, upd managed.ExternalUpdate, err error) (managed.ExternalUpdate, error) {
	if err != nil {
		return upd, err
	}
...
func preDelete(_ context.Context, cr *nsapitypes.DBCluster, obj *svcsdk.DeleteDBClusterInput) (bool, error) {
	obj.DBClusterIdentifier = pointer.ToOrNilIfZeroValue(meta.GetExternalName(cr))
...
func (e *custom) postDelete(ctx context.Context, cr *nsapitypes.DBCluster, obj *svcsdk.DeleteDBClusterOutput, err error) (managed.ExternalDelete, error) {
	if err != nil {
...
func filterList(cr *nsapitypes.DBCluster, obj *svcsdk.DescribeDBClustersOutput) *svcsdk.DescribeDBClustersOutput {
...
func (e *custom) updateTags(ctx context.Context, cr *nsapitypes.DBCluster, addTags []*svcsdk.Tag, removeTags []*string) error {
