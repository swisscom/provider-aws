...
// operation.
func GenerateDescribeOptionGroupsInput(cr *nsapitypes.OptionGroup) *svcsdk.DescribeOptionGroupsInput {
...
// GenerateOptionGroup returns the current state in the form of *nsapitypes.OptionGroup.
func GenerateOptionGroup(resp *svcsdk.DescribeOptionGroupsOutput) *nsapitypes.OptionGroup {
	cr := &nsapitypes.OptionGroup{}
...
func GenerateCreateOptionGroupInput(cr *nsapitypes.OptionGroup) *svcsdk.CreateOptionGroupInput {
...
func GenerateModifyOptionGroupInput(cr *nsapitypes.OptionGroup) *svcsdk.ModifyOptionGroupInput {
...
func GenerateDeleteOptionGroupInput(cr *nsapitypes.OptionGroup) *svcsdk.DeleteOptionGroupInput {
