...
func SetupOptionGroup(mgr ctrl.Manager, o controller.Options) error {
	name := managed.ControllerName(nsapitypes.OptionGroupGroupKind)
	opts := []option{
		func(e *external) {
	...
	r := managed.NewReconciler(mgr,
		resource.ManagedKind(nsapitypes.OptionGroupGroupVersionKind),
		reconcilerOpts...)
...
func preCreate(_ context.Context, cr *nsapitypes.OptionGroup, obj *svcsdk.CreateOptionGroupInput) error {
	obj.OptionGroupName = aws.String(meta.GetExternalName(cr))
	return nil
}

func preDelete(_ context.Context, cr *nsapitypes.OptionGroup, obj *svcsdk.DeleteOptionGroupInput) (bool, error) {
	obj.OptionGroupName = aws.String(meta.GetExternalName(cr))
	return false, nil
}

func preObserve(_ context.Context, cr *nsapitypes.OptionGroup, obj *svcsdk.DescribeOptionGroupsInput) error {
	obj.OptionGroupName = aws.String(meta.GetExternalName(cr))
	return nil
}

func postObserve(_ context.Context, cr *nsapitypes.OptionGroup, resp *svcsdk.DescribeOptionGroupsOutput, obs managed.ExternalObservation, err error) (managed.ExternalObservation, error) {
	if err != nil {
...
func filterList(cr *nsapitypes.OptionGroup, obj *svcsdk.DescribeOptionGroupsOutput) *svcsdk.DescribeOptionGroupsOutput {
...
func (e *hooks) isUpToDate(ctx context.Context, cr *nsapitypes.OptionGroup, obj *svcsdk.DescribeOptionGroupsOutput) (bool, string, error) {
...
func (e *hooks) preUpdate(ctx context.Context, cr *nsapitypes.OptionGroup, obj *svcsdk.ModifyOptionGroupInput) error {
