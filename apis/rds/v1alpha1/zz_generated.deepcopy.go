...
<<<<<<< HEAD
	...
	if in.ReplicateSourceDBClusterIDRef != nil {
		in, out := &in.ReplicateSourceDBClusterIDRef, &out.ReplicateSourceDBClusterIDRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.ReplicateSourceDBClusterIDSelector != nil {
		in, out := &in.ReplicateSourceDBClusterIDSelector, &out.ReplicateSourceDBClusterIDSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
	if in.ReplicateSourceDBInstanceID != nil {
		in, out := &in.ReplicateSourceDBInstanceID, &out.ReplicateSourceDBInstanceID
		*out = new(string)
		**out = **in
	}
	if in.ReplicateSourceDBInstanceIDRef != nil {
		in, out := &in.ReplicateSourceDBInstanceIDRef, &out.ReplicateSourceDBInstanceIDRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.ReplicateSourceDBInstanceIDSelector != nil {
		in, out := &in.ReplicateSourceDBInstanceIDSelector, &out.ReplicateSourceDBInstanceIDSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
=======
