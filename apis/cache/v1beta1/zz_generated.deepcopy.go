...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LogDeliveryConfigurations) DeepCopyInto(out *LogDeliveryConfigurations) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LogDeliveryConfigurations.
func (in *LogDeliveryConfigurations) DeepCopy() *LogDeliveryConfigurations {
	if in == nil {
		return nil
	}
	out := new(LogDeliveryConfigurations)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ReplicationGroupParameters) DeepCopyInto(out *ReplicationGroupParameters) {
	*out = *in
	...
	if in.LogDeliveryConfigurations != nil {
		...
		*out = make([]LogDeliveryConfigurations, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
